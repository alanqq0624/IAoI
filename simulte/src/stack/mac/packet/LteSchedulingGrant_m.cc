...
LteSchedulingGrant_Base::LteSchedulingGrant_Base(const char *name, short kind) : ::omnetpp::cPacket(name,kind)
{
    this->period = 0;
    this->expiration = 0;
...
LteSchedulingGrant_Base::LteSchedulingGrant_Base(const LteSchedulingGrant_Base& other) : ::omnetpp::cPacket(other)
{
    copy(other);
}
...
LteSchedulingGrantDescriptor::LteSchedulingGrantDescriptor() : omnetpp::cClassDescriptor("LteSchedulingGrant", "omnetpp::cPacket")
{
...
int LteSchedulingGrantDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='p' && strcmp(fieldName, "period")==0) return base+0;
    if (fieldName[0]=='e' && strcmp(fieldName, "expiration")==0) return base+1;
    if (fieldName[0]=='t' && strcmp(fieldName, "totalGrantedBlocks")==0) return base+2;
    if (fieldName[0]=='c' && strcmp(fieldName, "codewords")==0) return base+3;
    if (fieldName[0]=='g' && strcmp(fieldName, "grantedCwBytes")==0) return base+4;
...
int LteSchedulingGrantDescriptor::getFieldArraySize(void *object, int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    switch (field) {
        case 4: return pp->getGrantedCwBytesArraySize();
        default: return 0;
    }
}

const char *LteSchedulingGrantDescriptor::getFieldDynamicTypeString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
std::string LteSchedulingGrantDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    LteSchedulingGrant_Base *pp = (LteSchedulingGrant_Base *)object; (void)pp;
    switch (field) {
        case 0: return ulong2string(pp->getPeriod());
        case 1: return ulong2string(pp->getExpiration());
        case 2: return ulong2string(pp->getTotalGrantedBlocks());
        case 3: return ulong2string(pp->getCodewords());
        case 4: return ulong2string(pp->getGrantedCwBytes(i));
        default: return "";
    }
}

bool LteSchedulingGrantDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    LteSchedulingGrant_Base *pp = (LteSchedulingGrant_Base *)object; (void)pp;
    switch (field) {
        case 0: pp->setPeriod(string2ulong(value)); return true;
        case 1: pp->setExpiration(string2ulong(value)); return true;
        case 2: pp->setTotalGrantedBlocks(string2ulong(value)); return true;
        case 3: pp->setCodewords(string2ulong(value)); return true;
        case 4: pp->setGrantedCwBytes(i,string2ulong(value)); return true;
...
void *LteSchedulingGrantDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
